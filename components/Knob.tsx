...
const KnobControl = (props: KnobControlProps) => {
	...
	return (
		<VStack padding="5px">
			...
			>
				<Arc arcWidth={props.size / 20} background="gray" color={Theme.colors.brand.secondary} />
				<circle r={props.size * 0.4} cx={props.size / 2} cy={props.size / 2} fill="#2f2f2f" />
				<Pointer width={2} height={props.size / 10} radius={props.size * 0.3} type="rect" color="#fff" />
